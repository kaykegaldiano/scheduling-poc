                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50">
                                        ...
                                        <td class="flex flex-row px-6 py-4 gap-x-2">
                                            ...
                                            <form
                                                ...
                                                class="mb-0"
                                                action="{{ route('holidays.destroy', $holiday->id) }}" method="POST"
                                            >
                                                @csrf
                                                @method('DELETE')
